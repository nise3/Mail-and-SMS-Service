...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'rabbitmq' => [
            'driver' => 'rabbitmq',
            'queue' => env('RABBITMQ_QUEUE','mail.sms.q'),
            ...
            'options' => [
                'queue' => [
                    'exchange' => env('RABBITMQ_EXCHANGE_NAME','mail.sms.x'),
                    'exchange_type' => env('RABBITMQ_EXCHANGE_TYPE','topic'),
                    'exchange_routing_key' => env('EXCHANGE_ROUTING_KEY','mail.sms.routing.key'),
                ...
                'exchange' => [
                    'name' => env('RABBITMQ_EXCHANGE_NAME','mail.sms.x'),
                ...
                'alternate_exchange' => [
                    'name' => env('RABBITMQ_ALTERNATE_EXCHANGE', 'mail.sms.alternate.x'),
                    'type' => env('RABBITMQ_ALTERNATE_EXCHANGE_TYPE','fanout'),
                    'queue' => env('RABBITMQ_ALTERNATE_QUEUE','mail.sms.alternate.q')
                ],
                'dlx' => [
                    'name' => env('RABBITMQ_RETRY_DLX', 'mail.sms.dlx'),
                    'type' => env('RABBITMQ_RETRY_DLX_TYPE', 'fanout'),
                    'dlq' => env('RABBITMQ_RETRY_DLQ', 'mail.sms.dlq'),
